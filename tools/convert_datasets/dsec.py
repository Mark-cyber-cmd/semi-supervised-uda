...
def parse_args():
    ...
    parser.add_argument('dsec_path', default='data/gta', help='DSEC_Semantic data path')
    parser.add_argument('--gt-dir', default='gt_fine', type=str)
...
def main():
    ...
    gt_dir = osp.join(dsec_path, args.gt_dir)
